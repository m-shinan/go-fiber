...
import (
	...
	"github.com/m-shinan/go-fiber-postgres/models"
	"github.com/m-shinan/go-fiber-postgres/storage"
...
func (r *Repository) CreateBooks(context *fiber.Ctx) error {
	...
	if err != nil {
		context.Status(http.StatusBadRequest).JSON(
			&fiber.Map{"message": "coould not create book"})
		return err
	}
...
func (r *Repository) DeleteBook(context *fiber.Ctx) error {
	...
	context.Status(http.StatusOK).JSON(&fiber.Map{
		"message": "books dleted succesfully",
	})
	return nil
